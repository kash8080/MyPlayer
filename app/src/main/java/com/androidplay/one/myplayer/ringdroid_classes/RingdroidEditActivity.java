package com.androidplay.one.myplayer.ringdroid_classes;
        ...
        WaveformView.WaveformListener
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFilename = intent.getStringExtra("data").replaceFirst("file://", "").replaceAll("%20", " ");
        mSoundFile = null;
        mKeyDown = false;
    ...
    private void afterSavingRingtone(CharSequence title,
        ...
        // If we get here, that means the type is a ringtone. ask user to set this as ringtone or not

        AlertDialog.Builder builder=new AlertDialog.Builder(this);
        builder.setTitle(R.string.alert_title_success);
        builder.setMessage(R.string.aftersavePermission);
